...
En Streamlit-app der scraper Topas + danske konkurrenter (Albatros, Stjernegaard, Viktors Farmor, Ruby, Smilrejser, Jysk Rejsebureau, Gjøa, Best Travel, Nilles & Gislev, Fyrholt, Kipling, Vagabond, Bering Travel, Greenland Travel) og sammenligner pris + status per afgang. Bruges af head of agency (Gorm, gs@topas.dk) til at se hvornår konkurrenter ændrer pris eller bliver udsolgt.
