                ...
                "properties": {
                    ...
                    "availability_status": {
                        ...
                        "description": (
                            ...
                            "Map ALL of these to 'Åben': 'Ledig' (Viktors Farmor), "
                            "'Ledige pladser' (Jysk Rejsebureau), 'Plads' (without a "
                            "small number qualifier), 'Pladser' (plural without small "
                            "number), 'Bestil', 'Book nu', 'Reserver', or no status "
                            "word at all next to the date/price. "
                            "JYSK REJSEBUREAU specifically uses: 'Ledige pladser' = "
                            "'Åben', 'Få pladser' = 'Få pladser', 'Udsolgt' = 'Udsolgt'. "
                            "Do NOT confuse 'Ledige pladser' with 'Få pladser'. "
